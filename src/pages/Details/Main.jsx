    ...
    <>
      <div className="mt-5 flex-col justify-start tracking-widest">
        <div className="flex-col text-left">
          <h3 className="text-gray-200 text-4xl">
      ...
      <div className="flex gap-6">
        {data.runtime ? (
          ...
          <span>
            Episode Runtime:{" "}
            <span className="text-3xl">{time(data.episode_run_time)}</span>
          </span>
        )}
        <span>
      ...
      <div className="flex gap-6">
        {data.budget && (
          <p>
            Budget: <span className="text-2xl">{currency(data.budget)}</span>
          </p>
        )}
        {data.revenue && (
          <p>
            Revenue: <span className="text-2xl">{currency(data.revenue)}</span>
          </p>
        )}
      </div>
      {data.belongs_to_collection && (
        <div className="">
          Belongs to:
          <span className="text-2xl"> {data.belongs_to_collection?.name}</span>
          <img
